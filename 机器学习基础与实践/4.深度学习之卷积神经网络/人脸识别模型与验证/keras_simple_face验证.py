...
if __name__ == '__main__':
    ...
    (X_train, y_train), (X_val, y_val), (X_test,
                                        y_test) = load_data(r"E:\github远程仓库管理\python机器学习\simple_40_face\123.gif")
    ...
    model.load_weights(r"E:\github远程仓库管理\python机器学习\simple_40_face\facemodel_weights.h5") # 同样报错就改成这样的绝对路径
